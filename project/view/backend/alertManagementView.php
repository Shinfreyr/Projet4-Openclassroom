...
<?php
    while ($db = $request->fetch()){
        ...
        . '<span class="date col-3">' . htmlspecialchars($db['dateComment']) . '</span></h3>'
        ...
        . '<a class="chapterLink col-12 col-md-4 align-self-center suppComment" href="index.php?action=suppComment&idChapter='.htmlspecialchars($db['idComments']).'">Suprimer le commentaire</a>'
        . '<a class="chapterLink col-12 col-md-4 align-self-center resetAlert" href="index.php?action=resetAlert&idChapter='.htmlspecialchars($db['idComments']).'">Remettre à zero le compteur d\'alerte</a>'
